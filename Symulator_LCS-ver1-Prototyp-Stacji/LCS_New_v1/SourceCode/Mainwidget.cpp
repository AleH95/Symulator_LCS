...
void Widget::Train()
{
    ...
    if(temptor->getITrain()==0)
    {
        ...
        int max_train_speed = 50; //predkosc pociagu w km/h

       // connect(timer, SIGNAL(timeout()),this, SLOT( pociag[1]->train_move(timer,train_route[ROZMIARTRASY], max_train_speed));
    }
