...
public:
    ...
    int Ukosna;
    void WyznaczTrase();
    void decrementCiuf(int num);
    void incrementCiuf(int coord, int dir);
...
private:
    ...
    Pociag *Ciuf[CIUF];                                                   //Pociagi (tablica) w stacji (nr wejsciu,wyjsciu,perony)
