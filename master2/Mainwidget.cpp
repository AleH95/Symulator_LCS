...
void Widget::inizializza()
{
    ...
    for(j=0;j<LUNGHEZZA*ALTEZZA;j++)
    {
        ...
        //__________________________________________________________________________________
                        ...
                        {
                            QPixmap mypix ("D:/2.Informatyka/Qt/master2/Tor_prosty.png");
                            mypix=mypix.scaled(40,25);
                            alla[j]->setPixmap(mypix);
                            //alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/Tor_prosty.png);");
              ...
              /*  else if(IsInStos(j,RailroadO, RAILROADO) == true)
                ...
                {
                     QPixmap mypix ("D:/2.Informatyka/Qt/master2/lewy_gora.png");
                     mypix=mypix.scaled(40,25);
                     alla[j]->setPixmap(mypix);
                    //alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/lewy_gora.png);");
                }
                else if(IsIn(j,Railpg->getTab(),RAILPG) !=-1)
                {
            QPixmap mypix ("D:/2.Informatyka/Qt/master2/prawy_gora.png");
            mypix=mypix.scaled(40,25);
            alla[j]->setPixmap(mypix);
                    //alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/prawy_gora.png);");
                }
                else if(IsIn(j,Railld->getTab(),RAILLD) !=-1)
                {
            QPixmap mypix ("D:/2.Informatyka/Qt/master2/lewy_dol.png");
            mypix=mypix.scaled(40,25);
            alla[j]->setPixmap(mypix);
                    //alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/lewy_dol.png);");
                }
                else if(IsIn(j,Railpd->getTab(),RAILPD) !=-1)
                {
            QPixmap mypix ("D:/2.Informatyka/Qt/master2/prawy_dol.png");
            mypix=mypix.scaled(40,25);
            alla[j]->setPixmap(mypix);
                   // alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/prawy_dol.png);");
                }
                ...
                {
            QPixmap mypix ("D:/2.Informatyka/Qt/master2/lewy_gora_z.png");
            mypix=mypix.scaled(40,25);
            alla[j]->setPixmap(mypix);
                    //alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/lewy_gora_z.png);");
                }
                else if(IsIn(j,Railpgz->getTab(),RAILPGZ) !=-1)
                {
            QPixmap mypix ("D:/2.Informatyka/Qt/master2/prawy_gora_z.png");
            mypix=mypix.scaled(40,25);
            alla[j]->setPixmap(mypix);
                    //alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/prawy_gora_z.png);");
                }
                else if(IsIn(j,Railldz->getTab(),RAILLDZ) !=-1)
                {
            QPixmap mypix ("D:/2.Informatyka/Qt/master2/lewy_dol_z.png");
            mypix=mypix.scaled(40,25);
            alla[j]->setPixmap(mypix);
                    //  alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/lewy_dol_z.png);");
                }
                else if(IsIn(j,Railpdz->getTab(),RAILPDZ) !=-1)
                {
            QPixmap mypix ("D:/2.Informatyka/Qt/master2/prawy_dol_z.png");
            mypix=mypix.scaled(40,25);
            alla[j]->setPixmap(mypix);
                    //alla[j]->setStyleSheet("border-image:url(D:/2.Informatyka/Qt/master2/prawy_dol_z.png);");
                }
